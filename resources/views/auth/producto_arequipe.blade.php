...
@auth
    ...
    <div class="max-w-3xl w-full bg-white p-6 rounded-2xl shadow-lg text-gray-800 mt-10 animate-fadeIn">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-6">
            @php
                $otrosArequipes = [
                    ['img' => 'arequipe2.jpg', 'nombre' => 'Arequipe con chocolate', 'precio' => '$12.000'],
                    ['img' => 'arequipe3.jpg', 'nombre' => 'Arequipe sin azúcar', 'precio' => '$11.000'],
                    ['img' => 'arequipe4.jpg', 'nombre' => 'Arequipe con coco', 'precio' => '$13.000'],
                    ['img' => 'arequipe5.jpg', 'nombre' => 'Arequipe premium', 'precio' => '$15.000'],
                    ['img' => 'arequipe6.jpg', 'nombre' => 'Arequipe con almendras', 'precio' => '$14.000'],
                    ['img' => 'arequipe7.jpg', 'nombre' => 'Arequipe tradicional', 'precio' => '$10.000'],
                ];
            @endphp
