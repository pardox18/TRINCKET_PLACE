...
<body class="bg-blue-500 flex flex-col items-center min-h-screen text-white">
    ...
    <div class="max-w-5xl w-full bg-white p-6 rounded-2xl shadow-lg text-gray-800 mt-10 animate-slideUp">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
            @php
                $artesanos = [
                    ['img' => 'tallado1.jpg', 'nombre' => 'Figura Tallada', 'descripcion' => 'Figura de madera tallada a mano.', 'precio' => '$75.000'],
                    ['img' => 'cuero1.jpg', 'nombre' => 'Billetera de Cuero', 'descripcion' => 'Billetera artesanal de cuero genuino.', 'precio' => '$50.000'],
                    ['img' => 'cesta1.jpg', 'nombre' => 'Cesta Tejida', 'descripcion' => 'Cesta hecha a mano con fibras naturales.', 'precio' => '$40.000'],
                    ['img' => 'joya1.jpg', 'nombre' => 'Anillo de Plata', 'descripcion' => 'Anillo artesanal hecho con plata pura.', 'precio' => '$120.000'],
                    ['img' => 'ceramica2.jpg', 'nombre' => 'Plato de Cerámica', 'descripcion' => 'Plato decorativo hecho y pintado a mano.', 'precio' => '$35.000'],
                    ['img' => 'textil1.jpg', 'nombre' => 'Bufanda Tejida', 'descripcion' => 'Bufanda artesanal hecha con lana de alpaca.', 'precio' => '$60.000'],
                ];
            @endphp
